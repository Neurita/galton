...
The preferred way to contribute to galton is to fork the 
[main repository](http://github.com/alexsavio/galton/) on
GitHub:

1. Fork the [project repository](http://github.com/alexsavio/galton):
   click on the 'Fork' button near the top of the page. This creates
   a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:

          $ git clone git@github.com:YourLogin/galton.git
...
Finally, go to the web page of the your fork of the galton repo,
...
-  When adding additional functionality, provide at least one
   ...
   to other methods available in galton.
...
A great way to start contributing to galton is to pick an item
